    ...
    <div class="flex flex-1 min-h-screen">
        ...
        <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-navy-900 dark:bg-navy-950 border-r border-navy-800 text-gray-300">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto text-sm">
                ...
                <a href="{{ route('assistant.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('assistant.*') ? 'bg-gold-500 text-navy-950 font-bold' : 'hover:bg-navy-800 text-gray-300 hover:text-white' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3a9 9 0 100 18 9 9 0 000-18zm-4 9h8m-4-4v8" /></svg>
                    AI Assistant
                </a>
                ...
                <div class="pt-4 pb-1 text-[11px] font-semibold uppercase tracking-wider text-gray-400 px-3">System & Reports</div>
                <a href="{{ route('admin.reports.index') }}" class="flex items-center gap-3 px-3 py-2 rounded-lg transition-colors {{ request()->routeIs('admin.reports.*') ? 'bg-gold-500 text-navy-950 font-bold' : 'hover:bg-navy-800 text-gray-300 hover:text-white' }}">
