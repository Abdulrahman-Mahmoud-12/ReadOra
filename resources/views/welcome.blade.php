<x-layouts.app :title="'Welcome'">
    ...
    <section class="py-20 sm:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {{-- Feature 1 --}}
                <div class="group rounded-lg border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-gold-300 hover:shadow-lg dark:border-navy-800 dark:bg-navy-900 dark:hover:border-gold-600">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-gold-100 transition-transform group-hover:scale-110 dark:bg-gold-900/30">
                ...
                {{-- Feature 2 --}}
                <div class="group rounded-lg border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-gold-300 hover:shadow-lg dark:border-navy-800 dark:bg-navy-900 dark:hover:border-gold-600">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-navy-100 transition-transform group-hover:scale-110 dark:bg-navy-800">
                ...
                {{-- Feature 3 --}}
                <div class="group rounded-lg border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-gold-300 hover:shadow-lg dark:border-navy-800 dark:bg-navy-900 dark:hover:border-gold-600">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-purple-100 transition-transform group-hover:scale-110 dark:bg-purple-900/30">
                ...
                {{-- Feature 4 --}}
                <div class="group rounded-lg border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-gold-300 hover:shadow-lg dark:border-navy-800 dark:bg-navy-900 dark:hover:border-gold-600">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 transition-transform group-hover:scale-110 dark:bg-emerald-900/30">
                ...
                {{-- Feature 5 --}}
                <div class="group rounded-lg border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-gold-300 hover:shadow-lg dark:border-navy-800 dark:bg-navy-900 dark:hover:border-gold-600">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-rose-100 transition-transform group-hover:scale-110 dark:bg-rose-900/30">
                ...
                {{-- Feature 6 --}}
                <div class="group rounded-lg border border-gray-200 bg-white p-6 transition-all duration-300 hover:border-gold-300 hover:shadow-lg dark:border-navy-800 dark:bg-navy-900 dark:hover:border-gold-600">
                    <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-sky-100 transition-transform group-hover:scale-110 dark:bg-sky-900/30">
    ...
    <section class="py-20 sm:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative overflow-hidden rounded-lg bg-gradient-to-r from-navy-800 to-navy-900 p-8 sm:p-12 lg:p-16">
